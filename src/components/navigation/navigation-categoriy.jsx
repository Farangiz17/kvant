...
export default function NavigationCategoriy({ data }) {
  const categData = [
    {
      id: 14,
      title: "Сельхозтехника",
      image:
        "https://eu2.contabostorage.com/58ce315d623a4212847cf7e848a72942:kvanttest/6d2915f3-d649-4e48-bb90-5a0c6c6c6251.webp",
    ...
    },
    {
      ...
      image:
        "https://eu2.contabostorage.com/58ce315d623a4212847cf7e848a72942:kvanttest/eeb2403e-13c0-4cb2-a466-0cf62ae53c56.webp",
    ...
    },
    {
      ...
      title: "Насос Водяной",
      image:
        "https://eu2.contabostorage.com/58ce315d623a4212847cf7e848a72942:kvanttest/52e1c5ec-7181-4a53-8009-616709720133.jpg",
    ...
    },
    {
      ...
      title: "Прицепы",
      image:
        "https://eu2.contabostorage.com/58ce315d623a4212847cf7e848a72942:kvanttest/03afa809-9c4b-492a-8592-98523304d23b.png",
    ...
    },
    {
      ...
      title: "Стабилизатор",
      image:
        "https://eu2.contabostorage.com/58ce315d623a4212847cf7e848a72942:kvanttest/4c3b5f51-c37b-4958-8012-5484a0fa4624.jpeg",
    ...
    },
    {
      ...
      title: "Генератор",
      image:
        "https://eu2.contabostorage.com/58ce315d623a4212847cf7e848a72942:kvanttest/89e9e6b7-e023-49c4-809c-f88855e7ec58.webp",
    ...
    },
    {
      ...
      title: "Оборудования",
      image:
        "https://eu2.contabostorage.com/58ce315d623a4212847cf7e848a72942:kvanttest/92d8f905-a06e-4a7f-ad88-0c8a6b9731b5.webp",
  ...
  return (
    <div className="navigation-categoriy-parent">
      <div className="navigation-categoriy">
     <div className="navigation_menu--icon">
     <VscMenu />
     </div>
        {" "}
        <span className="navigation-categoriy_p">Все категории</span>
      </div>
      <span className="navigation-category-border-top"></span>
      <div className="categoriy_items">
        <ul className="categoriy_items_ul">
          {data.data &&
            data.data.map((item, index) => {
              return (
                <li className="categoriy_items_ul_li" key={item.id}>
                  <Link to={`/category/${item.id}`}>
                    {" "}
                    <img
                      className="categoriy_items_ul_li_icon"
                      src={item.icon}
                      alt="category icon photo"
                    />{" "}
                    {item.title}
                  </Link>
                </li>
